...
/**
 ...
 - Parameters:
   ...
   - before: 方法执行前回调，可获取 point 和 event
   - after: 方法执行后回调，可获取原始返回值并返回新值
 */
...
/**
 ...
 - Parameters:
   ...
   - before: 方法执行前回调，可获取 touches 和 event
...
/**
 ...
 - Parameters:
   - viewClass: 目标视图类（如 UIView.self）
   - before: 方法执行前回调（无参数）
   - after: 方法执行后回调，可获取原始返回值并返回新 CGSize
 */
