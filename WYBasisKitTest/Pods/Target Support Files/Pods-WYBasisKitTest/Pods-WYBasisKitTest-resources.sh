...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../ChatView/WYChatView.bundle"
  ...
  install_resource "${PODS_ROOT}/../../WYBasisKit/Activity/WYActivity.bundle"
  install_resource "${PODS_ROOT}/../../WYBasisKit/Localizable/WYLocalizable.bundle"
  install_resource "${PODS_ROOT}/../../WYBasisKit/Layout/BannerView/WYBannerView.bundle"
fi
