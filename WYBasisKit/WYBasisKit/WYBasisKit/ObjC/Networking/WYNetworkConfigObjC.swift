...
//    @objc public static var sessionDelegate: SessionDelegate? = nil
...
//    
//    /// 设置验证策略(安全等级)
//    @objc  public static var verifyStrategy: WYHttpsVerifyStrategyObjC = .pinnedCertificates
...
//    
//    /// 是否验证域名
//    @objc public static var validateDomain: Bool = true
//    @objc public var validateDomain: Bool = validateDomain
//    
//    /// 确定是否必须评估此“服务器信任管理器”的所有主机
//    @objc public static var allHostsMustBeEvaluated: Bool = true
...
//    
//    public init(trustManager: ServerTrustManager? = nil, sessionDelegate: SessionDelegate? = nil, serverCer: String = serverCer, clientP12: String = clientP12, clientP12Password: String = clientP12Password, verifyStrategy: WYHttpsVerifyStrategyObjC = verifyStrategy, defaultValidation: Bool = defaultValidation, validateDomain: Bool = validateDomain, allHostsMustBeEvaluated: Bool = allHostsMustBeEvaluated) {
