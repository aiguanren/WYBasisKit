...
@objcMembers public class WYBiometricAuthorizationObjC: NSObject {
    ...
    public static func verifyBiometrics(_ localizedFallbackTitle: String = "", localizedReason: String, handler: @escaping @MainActor (_ isBackupHandler: Bool, _ isSuccess: Bool, _ error: String) -> Void) {
