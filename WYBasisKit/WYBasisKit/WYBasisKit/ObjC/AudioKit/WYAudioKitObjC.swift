...
/// 音频相关错误类型
@objc(WYAudioError)
@frozen public enum WYAudioErrorObjC: Int {
...
@objcMembers public final class WYAudioKitObjC: NSObject {
    ...
    @objc public func startRecording(fileName: String? = nil, format: WYAudioFormatObjC = .aac) throws {
        guard let audioKit = audioKit else {
            throw NSError(domain: "WYAudioKitObjC", code: WYAudioErrorObjC.sessionConfigurationFailed.rawValue, userInfo: [NSLocalizedDescriptionKey: "WYAudioKit is not available"])
        }
